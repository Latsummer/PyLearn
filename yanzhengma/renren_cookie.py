...
if __name__ == "__main__":
    ...
    detaial_url = "http://www.renren.com/976484947/profile"
    detaial_page_text = session.get(url = detaial_url, headers = headers).text
    with open("./cookie.html", "w") as fp2:
        fp2.write(detaial_page_text)
